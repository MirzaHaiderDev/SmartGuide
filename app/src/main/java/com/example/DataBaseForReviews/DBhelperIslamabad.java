...
public class DBhelperIslamabad extends SQLiteOpenHelper {
    public DBhelperIslamabad(Context context) {
        super(context,"CustomerData.db", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase DB) {
        DB.execSQL("create Table IslamabadDetails(name Text primary key,email Text, phone Text)");
    }
